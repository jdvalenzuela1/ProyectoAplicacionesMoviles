...
public class NuevoClienteVistaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_nuevo_cliente_vista, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        guardarCliente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (nombreCliente.getText().toString().equals("") && apellidoCliente.getText().toString().equals("")) {
